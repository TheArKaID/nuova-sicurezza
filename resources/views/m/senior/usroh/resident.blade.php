            ...
            <div class="app-page-title">
                ...
                <div class="col-md-12">
                    <div class="row" style="display: grid">
                        <a href="{{route('senior.usroh.detail.resident.poin', ['id' => $resident->usroh->id, 'idr' => $resident->id])}}" class="btn btn-small btn-warning" style="float: right" onclick="loadui()">Catatan Pelanggaran</a>
                    </div>
                </div>
            </div>
        <div>
